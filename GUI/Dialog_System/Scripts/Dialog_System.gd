	...
	if _items:
		...
		for i in _items:
			if i is DialogCutscene:
				$CustsceneUI/AnimationPlayer.play("start")
...
func hide_dialog() -> void:
	...
	$CustsceneUI/AnimationPlayer.play("end")
	pass

func start_dialog() -> void:
	waiting_for_choice = false
	show_dialog_progress_indicator( false )
...
func set_dialog_choice ( _d : DialogChoice ):
	choice_options.visible=true
...
func show_dialog_progress_indicator( _is_visible : bool ) -> void:
