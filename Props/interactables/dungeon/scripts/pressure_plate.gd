...
@onready var audio_activate : AudioStream = preload("res://Props/interactables/dungeon/lever-01.wav")
@onready var audio_deactivate : AudioStream = preload("res://Props/interactables/dungeon/lever-02.wav")
